...
<main id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<button id="nav-control" class="b0">
			<svg width="35" height="24" viewBox="0 0 35 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path fill-rule="evenodd" clip-rule="evenodd" d="M35 1.81789C35 0.983114 34.3284 0.306396 33.5 0.306396H1.5C0.671574 0.306396 0 0.983114 0 1.81789C0 2.65266 0.671574 3.32938 1.5 3.32938H33.5C34.3284 3.32938 35 2.65266 35 1.81789ZM27 11.8945C27 11.0597 26.3284 10.383 25.5 10.383L1.5 10.383C0.671574 10.383 0 11.0597 0 11.8945C0 12.7293 0.671574 13.406 1.5 13.406L25.5 13.406C26.3284 13.406 27 12.7293 27 11.8945ZM17 21.9711C17 21.1363 16.3284 20.4596 15.5 20.4596L1.5 20.4596C0.671574 20.4596 0 21.1363 0 21.9711C0 22.8059 0.671574 23.4826 1.5 23.4826L15.5 23.4826C16.3284 23.4826 17 22.8059 17 21.9711Z" fill="white"/>
			</svg>
		</button>
